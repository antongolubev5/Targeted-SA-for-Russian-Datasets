...
def main():
    ...
    sentences = pd.read_csv('news_eval_test_cleaned.csv', sep='\t')[['text', 'textID', 'label', 'rus_entity']]
    encoder = {-1: 1, 0: 2, 1: 0}
    ...
    datasets = {'NLI_M': '/home/anton/PycharmProjects/ABSA-BERT-pair/data/rambler2011_json/bert-pair/test_NLI_M.tsv',
                ...
                'single': '/home/anton/PycharmProjects/ABSA-BERT-pair/data/rambler2011_json/bert-single/loc1_'
                          'вообще/test.tsv'}
    sentences = pd.read_csv('all_answers.csv', sep='\t')
    ...
    sentences.to_csv('all_answers.csv', sep='\t', index=False)
    # sentences = sentences[
