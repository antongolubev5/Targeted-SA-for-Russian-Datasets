...
def main():
    ...
    train = pd.read_csv(os.path.join(directory_path, 'news_eval_train_cleaned.csv'), sep='\t')
    test = pd.read_csv(os.path.join(directory_path, 'news_eval_test_cleaned.csv'), sep='\t')
